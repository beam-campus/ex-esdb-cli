defmodule ExESDBTui.MixProject do
  @moduledoc false
  use Mix.Project

  @app_name :ex_esdb_tui
  @elixir_version "~> 1.17"
  @version "0.0.1"
  @source_url "https://github.com/beam-campus/ex-esdb-tui"
  #  @homepage_url "https://github.com/beam-campus/ex-esdb"
  @docs_url "https://hexdocs.pm/ex_esdb_tui"
  # @package_url "https://hex.pm/packages/ex_esdb"
  # @issues_url "https://github.com/beam-campus/ex-esdb/issues"
  @description "ExESDBTui is a Terminal User Interface for ExESDB Event Stores"
